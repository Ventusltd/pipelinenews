...
import { bindNewspaperNewsV7Base, drawNewsNewsV7Base, loadNewsNewsV7Base } from "./newspaper-newsv7-base.js";
...
export function drawNewsNewsV7() {
...
export async function loadNewsNewsV7() {
  await loadNewsNewsV7Base();
  try {
...
export function bindNewspaperNewsV7(onNewsLoaded) {
  bindNewspaperNewsV7Base(onNewsLoaded);
