# PipelineNews V8 Architecture — Atman Decision Report

**Status:** DESIGN EVIDENCE ONLY — NO APPLICATION OR RELEASE CHANGE  
**Generated:** 202608262057 UTC by GitHub Actions  
**Repository:** Ventusltd/pipelinenews  
**Workflow dispatch commit:** `aea05bbab1a746a29c7728ddf2e0220aac81b594`  
**Performance evidence:** workflow run `#33010182783`  
...
|---|---:|---:|---:|---:|
| Project rows | 7,680 | 3,563 | 5,210 | 5,210 |
| DOM elements | 323,772 | 150,854 | 73,942 | 60,553 |
| Browser nodes | 609,861 | 284,602 | 127,537 | 169,520 |
| Decoded resources | 9.82 MB | 9.81 MB | 4.36 MB | 4.26 MB |
| Long-task total | 4,887 ms | 2,395 ms | 2,021 ms | 1,467 ms |
| REPD-date sort task | 5,897 ms | 2,460 ms | not comparable | not comparable |
| Scroll stress task | 11,628 ms | 5,799 ms | 3,903 ms | 4,911 ms |

PipelineNews creates 5.3× the original dashboard's DOM elements and 3.6× its browser nodes. Its mobile date sort blocks the main thread for approximately 5.9 seconds.
