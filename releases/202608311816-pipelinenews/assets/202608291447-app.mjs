...
boot().catch((error) => {
  console.error(error);
  document.getElementById("tbody").innerHTML = '<tr><td colspan="14" class="fast-fail">Canonical Q2 REPD data unavailable. The timestamped release has failed closed.</td></tr>';
