import { buildAtlasV8DeepLink } from "./202608271329-atlas-v8-deep-link-cartridge.js";

const GENERATION = "202608272048";
const EXPECTED_COMPILER_METHOD = "pipelinenews-v8-mobile-orientation-css-v3";
const EXPECTED_CACHE_IDENTITY = "f3620fff8b48a04e0e3264b472fe3af03dd8dbdb5cd65359e680d5d8d848afc2";
...
async function boot() {
  ...
  invariant(registry.schema === "pipelinenews.v8.live-news-registry.v1", "registry schema mismatch");
  ...
  apply({ syncUrl: false });
  document.getElementById("releaseMeta").textContent = `Mobile orientation repair + live news chronology candidate · ${rows.length.toLocaleString("en-GB")} canonical projects · ${registry.performance.maximum_physical_project_rows} physical rows · full details loaded only on demand · NOT DEPLOYED`;
