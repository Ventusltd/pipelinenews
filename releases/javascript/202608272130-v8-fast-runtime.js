...
const EXPECTED_COMPILER_METHOD = "pipelinenews-v8-sector-intelligence-three-grain-lazy-v3";
const EXPECTED_CACHE_IDENTITY = "38bf9950be3ef8e2d67a9401ae2b058a3349a704aee57cd6b858b97053bdd9d1";
...
async function boot() {
  ...
  apply({ syncUrl: false });
  document.getElementById("releaseMeta").textContent = `Live News + seven-topic sector intelligence candidate · ${rows.length.toLocaleString("en-GB")} canonical projects · ${registry.performance.maximum_physical_project_rows} physical rows · sector payload lazy · NOT DEPLOYED`;
