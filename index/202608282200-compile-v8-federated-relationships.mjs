...
const SOURCE_PARENT_COMMIT = "678a99033106d9837aa8c63b8fb3a56074d1bbd6";
...
function compileRuntime(parentBytes, cacheIdentity) {
  let source = parentBytes.toString("utf8");
  source = replaceExactly(source, "const WINDOW_SIZE = 50;", "const WINDOW_SIZE = 100;");
...
async function main() {
  ...
  const cacheContract = {
    ...
    runtime: { ...parentRegistry.cache_contract.runtime, physical_project_rows: 100 },
  ...
  const registry = {
    ...
    performance: { ...parentRegistry.performance, maximum_physical_project_rows: 100 },
  ...
  const manifest = {
    ...
    performance_contract: {
      ...
      maximum_physical_project_rows: 100,
