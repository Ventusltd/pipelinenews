...
const SOURCE_PARENT = "db9f7583b203d374781e2b38e7c7a8b86e32d8b3";
...
const COMPILER_METHOD = "pipelinenews-atlas-pointer-folder-deep-link-successor-v1";
let ATLAS_BASE = null;
...
function compileHtml(parentBytes) {
  ...
  html = replaceExactly(html, "<title>GlobalGrid2050 | PipelineNews seven-topic sector intelligence candidate</title>", "<title>PipelineNews | Atlas V9 deep-link successor 202608291504</title>");
...
async function main() {
  ...
  assert.equal(receiver.schema, "pipelinenews.gridatlas-pointer-receipt.v1");
  ...
  assert.equal(sourceManifest.schema, "pipelinenews.atlas-pointer-deep-link-successor-source.v1");
  ...
  const releaseManifest = {
    ...
    generation: GENERATION,
    release_id: RELEASE_ID,
    incepted_at: "2026-08-29T14:04:00Z",
    source_commit: sourceCommit,
    source_parent_commit: SOURCE_PARENT,
