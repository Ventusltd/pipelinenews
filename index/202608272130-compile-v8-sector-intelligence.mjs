...
const NAME = "PipelineNews Live News + seven-topic sector intelligence candidate";
...
function rewriteHtml(parentSource) {
  ...
  source = replaceRegexExactly(source, /<title>[^<]+<\/title>/u,
    "<title>GlobalGrid2050 | PipelineNews seven-topic sector intelligence candidate</title>");
