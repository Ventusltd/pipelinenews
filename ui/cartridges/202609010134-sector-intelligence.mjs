...
const TOPICS = Object.freeze([
  ...
  Object.freeze({ code: "GREAT_GRID_UPGRADE", label: "GREAT GRID UPGRADE", rank: 3 }),
  Object.freeze({ code: "WORLDWIDE_PV", label: "WORLDWIDE PV", rank: 4 }),
  Object.freeze({ code: "MV_HV_COMPONENTS", label: "MV/HV COMPONENTS", rank: 5 }),
]);
...
function validateAsset(asset) {
  ...
  if (!/^data\/202609010134-sector-intelligence\.json$/u.test(asset.url)) throw new Error("sector payload URL changed");
...
export function mountSectorIntelligence({ host, payloadAsset }) {
  ...
  heading.append(
    ...
    element("p", {}, "Sector context is separate from the 136-headline newspaper and cannot create or alter REPD project identity."),
  );
