...
invariant(GRIDATLAS_RECEIVER.schema === "pipelinenews.gridatlas-pointer-receipt.v1", "wrong pointer receipt schema");
...
export const ATLAS_V9_DEEP_LINK_CONTRACT = Object.freeze({
  ...
  generation: "202608291504",
  parent_generation: "202608291310",
