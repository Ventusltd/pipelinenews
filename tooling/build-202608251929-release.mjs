...
const officialSourcePinPath = "objects/source/sha256/84f4c36bfd72ee0fd50d9002d54c79088444a8a8e777bff54112fa89b56bfe99.json";
const cursorSourcePinPath = "objects/source/sha256/1fb5ae0e8a7453315d568e7053c70237b6e054f82eac219cb3ac70c4eba5422c.json";
...
const cursorSourceBytes = await readFile(abs(await exists(cursorSourcePinPath) ? cursorSourcePinPath : "state/official-source-cursor.json"));
const officialSourceBytes = await readFile(abs(await exists(officialSourcePinPath) ? officialSourcePinPath : "data/official-source/latest.json"));
