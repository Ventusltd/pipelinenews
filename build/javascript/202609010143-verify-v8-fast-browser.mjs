...
import {
  ...
  scanFeedEntries,
  validateContract,
} from "../../discovery/javascript/202609010143-sector-intelligence-runner.mjs";
...
async function verifySource(options) {
  ...
  assert.equal(ledger.datasets.sector_items.rows.length, 17);
  assert.equal(ledger.datasets.sector_item_topics.rows.length, 17);
...
for definition in contract["datasets"]:
    ...
    target=root / "releases" / "data" / "intelligence" / "202609010143" / directories[name] / "202609010143-part-000.parquet"
