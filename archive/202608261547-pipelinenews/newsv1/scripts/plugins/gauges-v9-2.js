...
export function initialiseGaugesV9_2() {
  ...
  charts.capacity = createGauge("g1", "#ff00ff", gaugeOptions);
  charts.projects = createGauge("g2", "#00ffff", gaugeOptions);
  charts.largest = createGauge("g3", "#00ff88", gaugeOptions);
}

export function loadGaugeChartsNewsV1() {
  if (typeof globalThis.Chart === "function") return Promise.resolve(true);
  ...
  chartLoadPromise = new Promise((resolve) => {
    ...
    script.onload = () => {
      ...
      if (typeof globalThis.Chart !== "function" || !gaugeOptions) return resolve(false);
      initialiseGaugesV9_2();
      updateGaugesV9_2(visible);
      return resolve(true);
    };
